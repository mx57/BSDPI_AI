...
> FluxRoute Desktop — GUI-оболочка для управления профилями `Flowseal/zapret-discord-youtube` в одном окне: запуск, обновление и переключение конфигураций.
...
<p align="center">
  ...
  Automatically launches, updates, and switches BAT profiles without manual configuration or restarts.
</p>
