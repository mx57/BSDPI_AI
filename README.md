...
>
> **BSDPI_AI является форком [klondike0x/BSDPI](https://github.com/klondike0x/BSDPI) и является родителем всех AI-функций**, которые сейчас присутствуют в оригинальном проекте — Thompson Sampling, генетическая эволюция, Network Fingerprinting, Wilson Score, Fast Start и другие.
>
> Эти функции были разработаны и реализованы в данном репозитории, после чего были включены в оригинальный BSDPI. **Автор оригинального проекта не упомянул этот факт** в своём репозитории и не указал BSDPI_AI в разделе благодарностей.
>
