...
> ### ℹ️ Происхождение проекта
>
> **BSDPI_AI является форком [klondike0x/FluxRoute](https://github.com/klondike0x/FluxRoute)** с независимо разработанным AI-слоем.
>
> **AI-функции** (Thompson Sampling, генетическая эволюция, Network Fingerprinting, Wilson Score, Fast Start, AI-оркестратор) были разработаны @mx57 и впервые появились в версии v1.4.1ai. Впоследствии эти же AI-функции были интегрированы в оригинальный проект klondike0x/FluxRoute, но **без указания авторства @mx57**. Это не является нарушением GPLv3 (лицензия允许ет повторное использование кода), однако мы считаем справедливым указать источник этих разработок.
>
> Оригинальный проект klondike0x/FluxRoute содержит базовую архитектуру, DPI-движки, WPF shell и core-сервисы. AI-расширения являются самостоятельной надстройкой, разработанной @mx57.
>
> Оба проекта распространяются под GPLv3. Весь код открыт — сообщество может самостоятельно проверить происхождение изменений.
...
- Это первый вклад @mx57 — AI-функции были разработаны независимо и впоследствии интегрированы в оригинальный `klondike0x/FluxRoute`
...
**[klondike0x](https://github.com/klondike0x) © 2026 · [mx57](https://github.com/mx57) © 2026 · GPLv3**
